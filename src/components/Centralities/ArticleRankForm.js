...
export default class extends Component {
  ...
  render() {
    const { labelOptions, relationshipTypeOptions, onChange, iterations, dampingFactor, writeProperty, weightProperty, defaultValue, concurrency, direction, persist } = this.props
