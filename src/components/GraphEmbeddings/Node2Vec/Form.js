...
const Node2VecForm = ({
                          ...
                          iterations, embeddingDimension, walkLength, inOutFactor, returnFactor
                      }) => {
...
const Parameters = ({iterations, embeddingDimension, walkLength, inOutFactor, returnFactor, onChange, readOnly}) => {
