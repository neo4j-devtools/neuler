...
export default class extends Component {
    ...
    render() {
        const { onChange, labelOptions, relationshipType, relationshipTypeOptions, relationshipOrientationOptions, startNodeId, endNodeId, startNode, endNode, weightProperty, defaultValue, concurrency, direction, persist } = this.props

        return (
            <Form size='mini' style={{ marginBottom: '1em' }}>
                <StreamOnlyForm onChange={onChange} relationshipOrientationOptions={relationshipOrientationOptions} relationshipType={relationshipType} direction={direction} persist={persist} concurrency={concurrency} labelOptions={labelOptions} relationshipTypeOptions={relationshipTypeOptions}/>
              <Form.Group inline>
