...
export default class extends Component {
  ...
  render() {
    const { onChange, labelOptions, relationshipTypeOptions,  balancedProperty, unbalancedProperty,  direction, persist } = this.props

    return (
      <Form size='mini' style={{ marginBottom: '1em' }}>
        <StreamOnlyForm onChange={onChange} direction={direction} persist={persist} labelOptions={labelOptions} relationshipTypeOptions={relationshipTypeOptions}/>
        <Form.Group inline>
          <Form.Field inline>
