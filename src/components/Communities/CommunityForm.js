...
export default ({onChange, relationshipType, direction, persist, concurrency, writeProperty, labelOptions, relationshipTypeOptions, relationshipOrientationOptions}) => (
  <React.Fragment>
  <Form.Field>
    <label>Label</label>
